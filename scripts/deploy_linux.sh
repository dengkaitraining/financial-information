#!/bin/bash
# ==============================================================================
# Linux 平台專用自動化部署與單元測試腳本 (scripts/deploy_linux.sh)
# 說明：針對 Native Linux (Ubuntu / Debian / RHEL) 執行服務啟動、權限自動校驗與單元測試
# ==============================================================================
set -e

echo "======================================================================"
echo "🐧 啟動 Linux 平台專案自動化部署與單元測試作業"
echo "======================================================================"

# 1. 檢查先決條件
if ! command -v docker >/dev/null 2>&1; then
    echo "❌ 錯誤：未安裝 Docker，請先安裝 Docker Engine 與 Docker Compose。"
    exit 1
fi
...
echo "3. 執行 Docker Compose 服務建置與啟動 (Native Linux 權限修復與初始化)..."
